...
import 'package:daftar_resep_makanan/cubit/resep_makanan_cubit.dart';
import 'package:daftar_resep_makanan/screen/detail_resep_makanan_screen.dart';
...
class _ResepMakananScreenState extends State<ResepMakananScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Kelvin K Saputra - 191011450389'),
      ),
